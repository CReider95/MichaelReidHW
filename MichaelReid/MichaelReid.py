...
class MichaelReid(ScriptedLoadableModule):
...
class MichaelReidWidget(ScriptedLoadableModuleWidget):
...
class MichaelReidLogic(ScriptedLoadableModuleLogic):
  ...
  def run(self, inputVolume, outputVolume, imageThreshold, enableScreenshots=0):
    ...
    if enableScreenshots:
      self.takeScreenshot('MichaelReidTest-Start','MyScreenshot',-1)
